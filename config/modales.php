...
<div class="modal fade" id="modalForms" tabindex="-1" aria-labelledby="modalFormsLabel" aria-hidden="true" data-mdb-backdrop="static" data-mdb-keyboard="false">
    <div id="tamForms" class="modal-dialog modal-dialog-centered ">
        <div class="modal-content">
            <div class="modal-header bg-eacii">
                <h5 class="modal-title" id="modalFormsLabel">
                    <span class="fa-solid fa-triangle-exclamation fa-lg"></span> Error
                </h5>
                <button type="button" class="btn-close btn-close-white" data-mdb-dismiss="modal" aria-label="Cerrar"></button>
            </div>
            <div class="modal-body text-center" id="bodyForms"></div>
        </div>
    </div>
</div>